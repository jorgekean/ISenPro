    ...
    public class PersonService : BaseService<UmPerson, PersonDto>, IPersonService
    {
        ...
        protected override UmPerson MapToEntity(PersonDto dto)
        {
            var entity = new UmPerson
            {
                ...
                DepartmentId = dto.DepartmentId.GetValueOrDefault(),
                Designation = dto.Designation,
                Email = dto.Email,
                EmployeeStatus = dto.EmployeeStatus.GetValueOrDefault(),
                EmployeeTitle = dto.EmployeeTitle.GetValueOrDefault(),
                IsHeadOfOffice = dto.IsHeadOfOffice,
                Remarks = dto.Remarks,
                SectionId = dto.SectionId.GetValueOrDefault(),
